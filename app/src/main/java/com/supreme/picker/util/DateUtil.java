package com.supreme.picker.util;

import com.supreme.picker.annotation.DayOfMonth;
import com.supreme.picker.annotation.Month;
import com.supreme.picker.annotation.Week;
...
public class DateUtil {
    ...
    public static boolean belongCalendar(Date nowTime, Date beginTime, Date endTime) {
        ...
        date.setTime(new java.util.Date(nowTime.getYear(), nowTime.getMonth(), nowTime.getDayOfMonth()));

        Calendar begin = Calendar.getInstance();
        begin.setTime(new java.util.Date(beginTime.getYear(), beginTime.getMonth(), beginTime.getDayOfMonth()));

        Calendar end = Calendar.getInstance();
        end.setTime(new java.util.Date(endTime.getYear(), endTime.getMonth(), endTime.getDayOfMonth()));

        return date.after(begin) && date.before(end);
    }

    public static boolean isAfter(Date beginTime, Date endTime) {
    ...
    public static boolean isEquals(Date firstDate, Date secondDate){
        Calendar date = Calendar.getInstance();
        date.setTime(new java.util.Date(firstDate.getYear(), firstDate.getMonth(), firstDate.getDayOfMonth()));

        Calendar begin = Calendar.getInstance();
        begin.setTime(new java.util.Date(secondDate.getYear(), secondDate.getMonth(), secondDate.getDayOfMonth()));

        return date.equals(begin);
    }
